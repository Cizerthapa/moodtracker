...
class _AddJournalEntryScreenState extends State<AddJournalEntryScreen>
  ...
  Future<void> _save() async {
    ...
    await widget.onSave(_textController.text.trim(), _selectedEmoji!);
  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedBuilder(
      ...
      builder: (context, _) {
        ...
        return Scaffold(
          // Solid warm cream — same as #FDF8F3
            ...
            children: [
                ...
                child: AnimatedContainer(
                  ...
                  decoration: BoxDecoration(
                    gradient: LinearGradient(
                      ...
                      colors: [
                        bg.withOpacity(0.60),
                        const Color(0xFFFDF8F3).withOpacity(0.94),
              ...
              Positioned(
                ...
                child: AnimatedContainer(
                  ...
                  decoration: BoxDecoration(
                    shape: BoxShape.circle,
                    color: _accentColor.withOpacity(0.045),
                  ),
                ),
              ),
              ...
              SafeArea(
                child: Column(
                  ...
                  children: [
                    ...
                    // ── "PICK A MOOD" label ──────────────────────────────
                    Padding(
                      padding: EdgeInsets.fromLTRB(24.w, 14.h, 0, 8.h),
                      child: Text(
                        'PICK A MOOD',
                        style: GoogleFonts.dmSans(
                          fontSize: 10.sp,
                        ...
                        child: AnimatedContainer(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              // Text field (expands to fill remaining card space)
                              Expanded(
                                child: Padding(
                                  padding: EdgeInsets.fromLTRB(
                                    18.w,
                    ...
                    // ── Insight strip (slides in when user starts typing) ─
                    SizeTransition(
                    ...
                    // ── Bottom bar: word count (left) + save pill (right) ─
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        borderRadius: BorderRadius.circular(24.r),
                        border: Border.all(
                          color: const Color(0xFFE8D9C0).withOpacity(0.55),
                        ),
                        boxShadow: [
                          BoxShadow(
...
/// Mood chip — rounded pill with emoji + label.
/// Lifts, tints and glows when selected.
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          color: selected ? tint : Colors.white.withOpacity(0.78),
          borderRadius: BorderRadius.circular(20.r),
          border: Border.all(
            color: selected ? accent : const Color(0xFFE8D9C0).withOpacity(0.6),
...
/// One segment of the triple-bar accent divider below the chips.
